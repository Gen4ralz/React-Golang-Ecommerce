...
export default function Accordian({ details }) {
  ...
  return (
    <div className={styles.infos_accordian}>
      <Accordion
      ...
      >
        ...
        <AccordionDetails>
          <div className={styles.infos_accordian_grid}>
            <p>{details[0]}</p>
          </div>
        </AccordionDetails>
        <AccordionDetails className="scrollbar">
          {details.slice(1, details.length).map((info) => (
            <div className={styles.infos_accordian_grid} key={info._id}>
              <span>{info.name}:</span>
      ...
      >
        ...
        <AccordionDetails>
          <div className={styles.infos_accordian_grid}></div>
        </AccordionDetails>
      </Accordion>
    </div>
  );
